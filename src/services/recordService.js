...
const mockData = [
  {
    ...
    nextContent: '',
    date: '06-09',
    createdAt: new Date('2024-06-09').getTime(),
  },
  {
    id: 2,
    title: '跨赴科技办公室深入了解',
    ...
    nextContent: '',
    date: '06-08',
    createdAt: new Date('2024-06-08').getTime(),
  },
  {
    id: 3,
    title: '奇绩 DemoDay',
    ...
    nextContent: '',
    date: '06-07',
    createdAt: new Date('2024-06-07').getTime(),
  },
  {
    id: 4,
    title: '线上会议初步沟通',
    detail: '通过Zoom进行了初步的项目介绍，对方团队背景强。',
    nextTime: '2024-06-10 15:00:00',
    nextContent: '准备详细的财务数据',
    date: '06-06',
    createdAt: new Date('2024-06-06').getTime(),
  },
  {
    id: 5,
    title: '路演活动偶遇',
    ...
    nextContent: '',
    date: '06-05',
    createdAt: new Date('2024-06-05').getTime(),
  },
  {
    id: 6,
    title: '产品演示会议',
    detail: '向对方团队演示了核心功能，反馈积极。',
    nextTime: '2024-06-12 10:00:00',
    nextContent: '发送产品白皮书',
    date: '06-04',
    createdAt: new Date('2024-06-04').getTime(),
  },
  {
    id: 7,
    title: '投委会前沟通',
    ...
    nextContent: '',
    date: '06-03',
    createdAt: new Date('2024-06-03').getTime(),
  },
]
